    ...
    return <div className="futura-font-light horizontal-padding">
        ...
        <div className="flex justify-sa vertical-margin">
            <div className="tech-section">
                ...
                <span className="font-64 red-accent">F</span>
                <span className="font-32">lutter</span>
                <div className="left-margin-20">
                    I always develop App using this lang.
                </div>
            </div>
            <div className="tech-section">
                ...
                <span className="font-64 red-accent">R</span>
                <span className="font-32">eact</span>
                <div className="left-margin-20">
                    This site is developed by this Framework.
                </div>
            </div>
            <div className="tech-section">
                ...
                <span className="font-64 red-accent">K</span>
                <span className="font-32">otlin</span>
                <div className="left-margin-20">
                    Graduation research <br/>in high school done by this lang.
                </div>
            </div>
        </div>
    </div>
